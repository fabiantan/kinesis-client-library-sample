...
public final class SampleKinesisApplication {
    ...
    private static final String DEFAULT_KINESIS_ENDPOINT = "https://kinesis.ap-southeast-2.amazonaws.com";
    ...
    //private static final InitialPositionInStream DEFAULT_INITIAL_POSITION = InitialPositionInStream.LATEST;
    ...
    private static void configure(String propertiesFile) throws IOException {
       ...
       AWSCredentialsProvider credentialsProvider = null;
        ...
        kinesisClientLibConfiguration = new KinesisClientLibConfiguration(applicationName, streamName,
         credentialsProvider, workerId).withInitialPositionInStream(initialPositionInStream).withKinesisEndpoint(kinesisEndpoint);
    }
